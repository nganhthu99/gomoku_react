export const calculateWinner = function (squares, step, boardSize, playerMove) {
    if (step[0] === null && step[1] === null)
        return {
            status: undefined,
            line: []
        }
...
export const checkBoardFull = function(squares) {
